...
//   }, [open]);
    ...
    const findAnswer = (text) => {
        ...
        for (let faq of FAQS) {
            if (input.includes(faq.q)) return faq.a;
        }
        return "🤖 I can help you with Mukundh’s skills, projects, experience, or contact info.";
    };
    ...
    return (
        ...
        {open && (
            ...
            <div
                className={`p-4 h-60 overflow-y-auto space-y-3 ${theme === "dark" ? "bg-transparent" : "bg-transparent"} chat-scrollbar-hide`}
                onWheel={e => {
            ...
            `}>
                ...
                />
                <button
                    className={` ps-4 pe-4 rounded-full transition 
                    ${theme === "dark"
